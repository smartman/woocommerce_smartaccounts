...
= 1.1 =
Woo order number reference is added to SmartAccounts invoice note
If company name is filled then invoice is connected to the Billing company
Discounted prices are used on invoices
Rounding calculation is added
Shipping item code is configurable
error.log is created in case of SmartAccounts communication issues
